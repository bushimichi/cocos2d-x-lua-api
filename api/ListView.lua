...
--------------------------------
-- 
-- @function [parent=#ListView] insertSelectItemModel 
-- @param self
-- @param #int index1
-- @param #int index2
-- @return ListView#ListView self (return value: ccui.ListView)
...
--------------------------------
-- 
-- @function [parent=#ListView] pushBackSelectItemModel 
-- @param self
-- @param #int index
-- @return ListView#ListView self (return value: ccui.ListView)
...
--------------------------------
-- 
-- @function [parent=#ListView] getItemCount 
-- @param self
...
--------------------------------
-- 
-- @function [parent=#ListView] addItemModel 
-- @param self
